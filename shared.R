...
read_csv("https://raw.githubusercontent.com/lexcauc/lexcauc-db/master/languages.csv", col_types = "ccccfdd") -> langs
...
#read_csv("../lexcauc-db/languages.csv",stringsAsFactors = FALSE, col_types = "cccfdd") -> langs