...
sapply(langs$lang.id,function(l){ 
  ...
  filename1 <- paste0("_languages/", l,".html")
  saveWidget(datatable(langtbl, escape = FALSE, rownames = FALSE,
            ...
            options = list(
              ...
              buttons = I('colvis'),
              fixedHeader = TRUE,
              pageLength = 20)), file.path(normalizePath(dirname(filename1)),basename(filename1)))
  
  filename2 <- paste0("_languages/", l, ".Rmd")
  ...
  text <- paste0("---\n",
                 ...
                 "  html_document:\n",
                 "    includes:\n",
                 "      after_body: ", basename(filename1),"\n",
                 "---")
  writeLines(text,file.path(normalizePath(dirname(filename2)),basename(filename2)))
})
```
