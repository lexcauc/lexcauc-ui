...
sapply(langs$lang.id,function(l){ 
  ...
  filename1 <- paste0("languages/_", l,".html")
  ...
  filename2 <- paste0("languages/", l, ".Rmd")
...
langs %>% transmute(lang.name = paste0("<a href='languages/", lang.id, ".html' target = '_blank'>",lang.name,"</a>"), group = group) -> langlist
